  ...
  return (
    <section id="contact" className="border-t border-border py-24 md:py-32">
      <Reveal className="mx-auto max-w-2xl px-6 text-center">
        ...
        <div className="mx-auto mt-14 flex max-w-sm flex-col gap-4 border-t border-border pt-10 text-sm sm:max-w-none sm:flex-row sm:flex-wrap sm:justify-center sm:gap-10">
          <a
            href={`mailto:${EMAIL}`}
            data-cursor="link"
